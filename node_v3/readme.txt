...
This firmware package contains a complete implementation of the network layer of our net stack, and a testing application (app_bounce, collatz, sensor) to demonstrate aspects of its functionality and usage of the network APIs.

It also includes a sensor driver for the DHT22 sensor (dht.c/.h).
